...
def import_data(v):
    train_path = f"data/Federated/CIFAR_alpha1_{v}_train.pck"
    test_path = f"data/Federated/CIFAR_alpha1_{v}_test.pck"
...
def main():
    ...
    for v in run_list:
        ...
        with multiprocessing.Pool(initializer=init, initargs=(v, ), processes=1) as pool:        
            ...
            # with open(f"results/CIFAR_alpha1_{v}.json", "w") as f:
