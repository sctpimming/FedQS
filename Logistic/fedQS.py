...
from util.metric import accuracy, crossentropy, macro_f1
...
def import_data(v):
    train_path = f"data/Federated/MNIST_alpha05_{v}_train.pck"
    test_path = f"data/Federated/MNIST_alpha05_{v}_test.pck"
...
def FedAvg(policy):
    ...
    for t in tqdm(range(T), miniters=10):
        ...
        f1_test[t] = macro_f1(w_avg, test_data["user_data"]["test"], test_size, K, C, M)
